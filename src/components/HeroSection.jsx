    ...
    <section className={`relative min-h-[600px] md:h-[840px] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} ref={ref} data-name="Section" data-node-id="79:3106">
      ...
      <div className="pt-[40px] md:pt-[76px]">
        <div className="max-w-[705px]">
          ...
          <h1 className="text-[32px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[54px] font-bold leading-[38px] sm:leading-[44px] md:leading-[50px] lg:leading-[56px] xl:leading-[60px] tracking-[-1px] sm:tracking-[-1.2px] md:tracking-[-1.5px] lg:tracking-[-1.6px] xl:tracking-[-1.8px] text-[#0f1729] mb-[20px] md:mb-[24px] animate-slide-up" data-node-id="79:3116">
            <span>A Smarter Way to Manage</span>
            <br />
            <span className="bg-clip-text bg-gradient-to-r from-[#1d9883] to-[#098a74] text-transparent">
              NAAC, NBA, and NIRF
            </span>
          </h1>
          ...
          <p className="text-[#65758b] text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] xl:text-[20px] font-normal leading-[24px] sm:leading-[25px] md:leading-[26px] lg:leading-[27px] xl:leading-[28px] mb-[30px] md:mb-[40px] max-w-[682px] animate-fade-in-delay" data-node-id="79:3117">
            A single platform that normalises data, auto-allocates tasks, predicts scores, generates SSR/AQAR, and guides institutions from C to A++ with AI-driven insights.
          </p>
          ...
          <div className="text-left text-[#65758b] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[16px] font-normal leading-[18px] sm:leading-[19px] md:leading-[20px] lg:leading-[20px] mb-[12px] md:mb-[16px] px-4 md:px-0" data-node-id="79:3126">
            Key Performance Gains
          </div>
          
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-start gap-[12px] md:gap-[14px] lg:gap-[20px] text-[rgba(0,0,0,0.6)] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[16px] font-bold leading-[22px] sm:leading-[24px] md:leading-[26px] lg:leading-[28px] px-4 md:px-0" data-node-id="79:3127">
            <span>90% Workflow Automation</span>
            <div className="hidden sm:block bg-[#e1e7ef] h-[24px] w-px" data-name="Vertical Divider" data-node-id="79:3129" />
            <span>95% Better Team Coordination</span>
            <div className="hidden sm:block bg-[#e1e7ef] h-[24px] w-px" data-name="Vertical Divider" data-node-id="79:3131" />
            <span>A++ Achievers</span>
          </div>
        </div>
      </div>
      </div>
